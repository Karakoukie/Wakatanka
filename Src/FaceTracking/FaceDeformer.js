...
var FaceDeformer = function () {
    ...
    this.load = function (element, points, pModel, vertices) {
        ...
        if (first) {
            ...
            var gridVertexShader = gl.createShader(gl.VERTEX_SHADER);
            gl.shaderSource(gridVertexShader, gridVertexShaderProg);
            gl.compileShader(gridVertexShader);

            var gridFragmentShader = gl.createShader(gl.FRAGMENT_SHADER);
            gl.shaderSource(gridFragmentShader, gridFragmentShaderProg);
            ...
            gl.shaderSource(vertexShader, vertexShaderProg);
            gl.compileShader(vertexShader);

            var fragmentShader = gl.createShader(gl.FRAGMENT_SHADER);
            gl.shaderSource(fragmentShader, fragmentShaderProg);
